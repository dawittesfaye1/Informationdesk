...
namespace Informationdesk.Controllers
{
    public class AnnouncementsController : Controller
    {
        ...
        [Authorize]
        public async Task<IActionResult> Create([Bind("Id,Name,Describtion,Date")] Announcements announcements)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Describtion,Date")] Announcements announcements)
        {
